...
function ProductList({ onHomeClick }) {
    ...
    // UPDATED STYLE FOR THE CART COUNT
    const styleCartCount = {
        position: 'absolute',
        top: '50%', // Centers vertically
        left: '50%', // Centers horizontally
        transform: 'translate(-50%, -50%)', // Ensures exact center alignment
        color: 'white', // Make text white so it pops against the green nav background
        fontSize: '20px',
        fontWeight: 'bold',
        zIndex: 100,
            ...
            <div className="navbar" style={styleObj}>
                ...
                <div style={styleObjUl}>
                    ...
                    <div style={{ position: 'relative' }}> 
                        ...
                        {totalQuantity > 0 && (
                            <span style={styleCartCount}>{totalQuantity}</span>
                        )}
                    </div>
                </div>
            </div>
